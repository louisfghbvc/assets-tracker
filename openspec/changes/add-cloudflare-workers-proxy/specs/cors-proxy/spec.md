...
## Purpose
Define requirements for the Cloudflare Workers-based CORS proxy that enables reliable cross-origin requests from the GitHub Pages frontend to financial data APIs.
